  ...
  return (
    <div className='sidebar'>
      <ul className='sidebar_options'>
        ...
        <li><Link to={RouteStrings.createuser} className='sidebar_link'>Users</Link> </li>
        ...
        <li><Link to={RouteStrings.companydetails} className="sidebar_link">Company Details</Link></li>
      </ul>
    </div>
  )
}
