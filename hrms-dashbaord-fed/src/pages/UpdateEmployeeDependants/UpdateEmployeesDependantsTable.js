...
export const UpdateEmployeeDependantsTable = () => {
          ...
          <div className="w-100 d-flex align-items-center justify-content-center">
            <div className="update_emp_dependants_inp_div">
              <Form.Select aria-label="Default select example">
                ...
                <option value="dev_ops_team">Dev Ops Team</option>
                <option value="ad_operations">Ad Operations</option>
              </Form.Select>
            </div>
          </div>
        ),
          ...
          <div className="w-100 d-flex align-items-center justify-content-center">
            <div className="update_emp_dependants_inp_div">
              <Form.Select aria-label="Default select example">
                ...
                <option value="client_services">HR </option>
                <option value="dev_ops_team">Manager</option>
                <option value="ad_operations">Employee</option>
              </Form.Select>
            </div>
          </div>
        ),
          ...
          <div className="w-100 d-flex align-items-center justify-content-center">
            <div className="update_emp_dependants_inp_div">
              <Form.Select aria-label="Default select example">
                ...
                <option value="client_services">Intern</option>
                <option value="dev_ops_team">Regular/Permanent</option>
                <option value="ad_operations">Temporary</option>
              </Form.Select>
            </div>
          </div>
        ),
          ...
          <div className="w-100 d-flex align-items-center justify-content-center">
            <div className="update_emp_dependants_inp_div">
              <Form.Select aria-label="Default select example">
                ...
                <option value="client_services">Morning</option>
                <option value="dev_ops_team">Afternoon</option>
                <option value="ad_operations">Night</option>
              </Form.Select>
            </div>
          </div>
        ),
          ...
          <div className="w-100 d-flex align-items-center justify-content-center">
            <div className="update_emp_dependants_inp_div">
              <Form.Select aria-label="Default select example">
                ...
                <option value="client_services">Backend</option>
                <option value="dev_ops_team">Frontend</option>
                <option value="ad_operations">Full Stack</option>
              </Form.Select>
            </div>
          </div>
        ),
  ...
  console.log(
    "🚀 ~ file: UpdateEmployeesDependantsTable.js:203 ~ UpdateEmployeeDependantsTable ~ selectedFlatRows:",
    selectedFlatRows
  );
